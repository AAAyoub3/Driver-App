...
// in flowery/test/modules/auth/data/data_sources/auth_remote_data_source_imp_test.dart.
...
class MockAuthApiClient extends _i1.Mock implements _i3.AuthApiClient {
  ...
  @override
  _i4.Future<_i2.LoginResponse> login(_i5.LoginRequestModel? requests) =>
      (super.noSuchMethod(
            Invocation.method(#login, [requests]),
            returnValue: _i4.Future<_i2.LoginResponse>.value(
              _FakeLoginResponse_0(this, Invocation.method(#login, [requests])),
            ),
          )
